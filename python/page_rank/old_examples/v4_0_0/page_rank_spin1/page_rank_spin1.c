...
/****f* page_rank.c/routing_table_init
*
* SUMMARY
...
/****f* page_rank.c/send_temps_to_host
*
* SUMMARY
...
#ifdef VERBOSE
  // say hello
  io_printf (IO_BUF, "starting page_rank_spin1\n");
#endif
...
#ifdef VERBOSE
    // say goodbye
    io_printf (IO_BUF, "stopping page_rank_spin1\n");
#endif
}
/*
*******/
