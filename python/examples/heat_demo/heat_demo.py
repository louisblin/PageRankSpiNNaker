        ...
        if vertices[x][y] is not None:
            ...
            if (y + 1) < max_y_element_id and vertices[x][y + 1] is not None:
                front_end.add_partitioned_edge(
                    ...
                    label="North Edge from {}, {} to {}, {}".format(x, y, x + 1, y),
                    partition_id="TRANSMISSION")
            ...
            if (x + 1) < max_y_element_id and vertices[x + 1][y] is not None:
                front_end.add_partitioned_edge(
                    ...
                    label="East Edge from {}, {} to {}, {}".format(x, y, x + 1, y),
                    partition_id="TRANSMISSION")
            ...
            if (y - 1) >= 0 and vertices[x][y - 1] is not None:
                front_end.add_partitioned_edge(
                    ...
                    label="South Edge from {}, {} to {}, {}".format(x, y, x, y - 1),
                    partition_id="TRANSMISSION")
            ...
            if (x - 1) >= 0 and vertices[x - 1][y] is not None:
                front_end.add_partitioned_edge(
                    ...
                    label="West Edge from {}, {} to {}, {}".format(x, y, x - 1, y),
                    partition_id="TRANSMISSION")
...
def receive_heat(label, atom, value):
    condition.acquire()
    print "RECEIVED {}: {}".format(label, value / 65536.0)
    condition.release()
